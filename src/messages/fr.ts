...
const fr: Messages = {
	...
	Webhooks: {
		title: "Webhooks",
		description: "Gérer les webhooks pour cette organisation.",
		url: "URL",
		descriptionHeader: "Description",
		events: "Événements",
		eventsEmpty: "Tous les événements",
		enabled: "Activé",
		secret: "Secrète",
	},
	WebhookForm: {
		...
		url: "URL",
		events: "Événements",
		eventsDescription: "Laissez vide pour recevoir tous les événements",
		eventsPlaceholder: "Envoi de tous les événements",
		enabled: "Activé",
		headers: "En-têtes",
	},
	UpdateWebhook: {
		title: "Mettre à jour le Webhook",
		description: "Mettre à jour un webhook pour cette organisation.",
		signingSecret: "Secret de signature",
		toast: "Webhook mis à jour",
	},
	KeyValueField: {
		add: "Ajouter",
		delete: "Supprimer",
