const en = {
	...
	Webhooks: {
		title: "Webhooks",
		description: "Manage the webhooks for this organization.",
		url: "URL",
		descriptionHeader: "Description",
		events: "Events",
		eventsEmpty: "All events",
		enabled: "Enabled",
		secret: "Secret",
	},
	WebhookForm: {
		...
		url: "URL",
		events: "Events",
		eventsDescription: "Leave blank to receive all events",
		eventsPlaceholder: "Sending all events",
		enabled: "Enabled",
		headers: "Headers",
	},
	UpdateWebhook: {
		title: "Update Webhook",
		description: "Update a webhook for this organization.",
